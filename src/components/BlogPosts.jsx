      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="max-w-2xl mx-auto">
           ...
           Lorem ipsum dolor sit, amet consectetur adipisicing elit. Alias quasi voluptate dolor tempora harum porro laboriosam architecto dolores voluptatem dolorem?
            </p>
